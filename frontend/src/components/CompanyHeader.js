        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto align-items-center">
            <li className="nav-item">
              <NavLink to="/chome" style={navLinkStyles}>Home</NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/companyProfile" style={navLinkStyles}>Profile</NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/company" style={navLinkStyles}>Create</NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/capplications" style={navLinkStyles}>Applications</NavLink>
            </li>
            <li className="nav-item">
